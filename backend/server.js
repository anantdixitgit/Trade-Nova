...
const Holding = require("./Routes/holding.routes.js");
const Position = require("./Routes/position.routes.js");
...
//getting holdings data from server
...
//ROUTES for adding data in database
...
// MONGO DB CONNECTION BEFORE STARTING SERVER

const startServer = async () => {
  try {
    await dbConnect(); // Connect to MongoDB before starting the server
