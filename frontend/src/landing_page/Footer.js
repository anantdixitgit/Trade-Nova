  ...
  return (
    <div className="container mt-5 border-top ">
      <div className="row mt-5">
        <div className="col">
          <img src="media/TradeNova.png" style={{ width: "60%" }}></img>

          <p>
            &copy; 2010 - 2024 , Not Trade Nova Broking Ltd. All rights reserved
            .
          </p>
        </div>
        ...
        >
          <p>
            Trade Nova Broking Ltd.: Member of NSE, BSE​ &​ MCX – SEBI
            Registration no.: INZ000031633 CDSL/NSDL: Depository services
            through Trade Nova Broking Ltd. – SEBI Registration no.:
            IN-DP-431-2019 Commodity Trading through TradeNova Commodities Pvt.
            Ltd. MCX: 46025; NSE-50001 – SEBI Registration no.: INZ000038238
            Registered Address: Trade Nova Broking Ltd., #153/154, 4th Cross,
            Dollars Colony, Opp. Clarence Public School, J.P Nagar 4th Phase,
            Bengaluru - 560078, Karnataka, India. For any complaints pertaining
            to securities broking please write to complaints@TradeNova.com, for
            DP related to dp@TradeNova.com. Please ensure you carefully read the
          ...
          <p>
            ...
            others. If you find anyone claiming to be part of Trade Nova and
